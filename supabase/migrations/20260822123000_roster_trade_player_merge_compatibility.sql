-- Keep the canonical player-identity merge compatible with the typed player
-- reference introduced by roster transaction movements. Historical transaction
-- rows remain intact; only the duplicate identity key is redirected.
